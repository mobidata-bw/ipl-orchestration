...
- ⚠️ `gtfs-db`: upgrade [`postgis-with-pg-plan-filter`](https://github.com/mobidata-bw/postgis-with-pg-plan-filter) to [`2025-06-04t13.24.41-f4067ea`](https://github.com/mobidata-bw/postgis-with-pg-plan-filter/tree/f4067ea) – Because this upgrades PostgreSQL to v16, to upgrade, you will have to
