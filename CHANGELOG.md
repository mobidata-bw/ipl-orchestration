...
- ⚠️ `gtfs-db`: Adapt memory- & I/O-related PostgreSQL config parameters to modern-day hardware, i.e. assume >1 cores, 10GB RAM and an SSD being available for the DB. – This change *might be* breaking if you run IPL in a very constrained environment and either use the default parameters or a custom configuration (you'd have to ensure it still applies).
...
- GeoServer layer `MobiData-BW:charge_points`
  -  add `status_last_updated` and `realtime_data_outdated`
  -  remove `chargepoint_bike_count`
  -  count connectors instead of EVSEs for all `chargepoint_<evse.status>_count` attributes
...
- [ParkAPI 0.44.1](https://github.com/ParkenDD/park-api-v3/blob/ebad94465f798eef20185583e10c28b1470cce5e/CHANGELOG.md#0441)
   - with a fix for a forein key exception when deleting duplicates
  - with recreated konstanz bike converter
  - with an extended bfrk bike parking
- [OCPDB 2.12.3](https://github.com/binary-butterfly/ocpdb/blob/f7abe91bee265111d3f30d2382bdc73f4ed5230a/CHANGELOG.md#2120)
...
- GeoServer: remove outdated `gwc-layers`
- OCPDB 2.11.0
  - with several new Datex2 data sources
  - with optimizations for Location API for faster responses
...
- `ingess`: upgrade [`traefik`](https://hub.docker.com/_/traefik) to [`v3.6.9`](https://github.com/traefik/traefik/blob/v3.6.9/CHANGELOG.md)
- `caddy`: upgrade [`caddy`](https://hub.docker.com/_/caddy) to [`2.11.1-alpine`](https://hub.docker.com/layers/library/caddy/2.11.1-alpine/images/sha256-a4983e09003e598c28ef85197c16bb2fdd34da8b2526487c0d144f38fd3b2970) ([v2.10.2 release](https://github.com/caddyserver/caddy/releases/tag/v2.10.2), [v2.11.0 release](https://github.com/caddyserver/caddy/releases/tag/v2.11.0), [v2.11.1 release](https://github.com/caddyserver/caddy/releases/tag/v2.11.1))
...
- [ParkAPI 0.41.1](https://github.com/ParkenDD/park-api-v3/blob/a4f19e928c5aefc4a215e7ee7469e640f7bbab2b/CHANGELOG.md#0411)
  - enabling realtime sources at karlsruhe disabled
...
- [ParkAPI 0.35.0](https://github.com/ParkenDD/park-api-v3/blob/1c9f68891526b5091c347d9789838f5f0cb748bb/CHANGELOG.md#0350)
  - ⚠️ with new restriction system
      - ParkingSites and ParkingSpots: `restricted_to` array is deprecated. Instead, this information can be set in the `restrictions` array, e.g.: `"type": "CHARGING"`
...
- [ParkAPI 0.32.1](https://github.com/ParkenDD/park-api-v3/blob/ca0a3c121fa2bae5f982f1063b3d84e417ac8c24/CHANGELOG.md#0321)
  - allowing linestrings at rudolfzell
...
- GeoServer
	- new ParkAPI layers `MobiData-BW:park-api_car_lines` and `MobiData-BW:park-api_car_polygons` with respective styles
 	- ⚠️ change name from `num_scooters_standing_available` to `num_scooters_available` in `MobiData-BW:sharing_stations`
